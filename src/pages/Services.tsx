  ...
  const services = [
    {
      icon: Award,
      title: t('Leseni'),
      description: t('Apply for or renew your driver license with our streamlined digital process.'),
      features: [
        t('Online application and renewal'),
        t('Document upload and verification'),
        t('Real-time status tracking'),
      ],
    ...
    },
    {
      icon: FileCheck,
      title: t('JiTesti'),
      description: t('Take professional driver tests for categories A through E with multimedia questions.'),
      features: [
        t('Multiple-choice questions with images and videos'),
        t('Instant scoring and results'),
        t('Digital certificate upon passing'),
      ],
      route: '/test/category',
    },
    {
      icon: BookOpen,
      title: t('Elimika'),
      description: t('Access comprehensive driver education courses with various learning materials.'),
      features: [
        t('Text, PDF, and video lessons'),
        t('Interactive quizzes and assessments'),
        t('Progress tracking and certificates'),
      ],
      route: '/elimika',
    },
    {
      icon: Briefcase,
      title: t('Ajira ya Udereva'),
      description: t('Create your driver profile and apply for jobs with verified employers.'),
      features: [
        t('Build a professional driver profile'),
        t('Browse and apply for job opportunities'),
    ...
    {
      icon: UserCheck,
      title: t('Ajiri Dereva'),
      description: t('Post job openings and hire verified, qualified drivers for your business.'),
      features: [
        t('Post job listings with requirements'),
        t('Review driver profiles and applications'),
        t('Match with qualified candidates'),
      ],
