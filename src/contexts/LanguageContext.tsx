...
const translations = {
  en: {
    ...
    recentActivityDesc: 'Your latest interactions with our services',
    noRecentActivity: 'No recent Jitesti activities found.',
    ...
    recentApplicantsDesc: 'Latest applications to your job posts',
    quickActions: 'Quick Actions',
    quickActionsDesc: 'Common tasks',
    recentJobPosts: 'Recent Job Posts',
    recentJobPostsDesc: 'Your latest job vacancies',
    ...
    outsourceDriver: 'Outsource a Driver',
    myOutsourceRequests: 'My Outsource Requests',
    messages: 'Messages',
    ...
    adminDashboardDesc: 'Manage the entire Dereva Huduma platform',
  ...
  sw: {
    ...
    welcome: 'Karibu',
    dashboard: 'Dashibodi',
    employerDashboard: 'Dashibodi ya Mwajiri',
    noteFromAdmin: 'Ujumbe kutoka kwa Msimamizi',
    myProfile: 'Wasifu Wangu',
    myResults: 'Matokeo Yangu',
    notifications: 'Arifa',
    recentActivity: 'Shughuli za Hivi Karibuni',
    recentActivityTitle: 'Shughuli za Hivi Karibuni',
    recentActivityDesc: 'Mwingiliano wako wa hivi karibuni na huduma zetu',
    noRecentActivity: 'Hakuna shughuli za Jitesti za hivi karibuni zilizopatikana.',
    ...
    recentApplicants: 'Waombaji wa Hivi Karibuni',
    recentApplicantsDesc: 'Maombi ya hivi karibuni kwenye kazi zako',
    quickActions: 'Vitendo vya Haraka',
    quickActionsDesc: 'Kazi za kawaida',
    recentJobPosts: 'Kazi Mpya Zilizochapishwa',
    recentJobPostsDesc: 'Nafasi zako mpya za kazi',
    manageJobs: 'Simamia Kazi',
    viewAll: 'Tazama Zote',
    postNewJob: 'Chapisha Kazi Mpya',
    manageJobPosts: 'Simamia Kazi Zilizochapishwa',
    viewShortlist: 'Tazama Orodha Fupi',
    scheduleInterview: 'Panga Mahojiano',
    outsourceDriver: 'Kabidhi Huduma ya Dereva',
    myOutsourceRequests: 'Maombi Yangu ya Kukabidhi',
    messages: 'Ujumbe',
    ...
    // Admin
    adminDashboardTitle: 'Dashibodi ya Usimamizi',
    adminDashboardDesc: 'Simamia jukwaa lote la Dereva Huduma',
    totalDrivers: 'Madereva Jumla',
    totalEmployers: 'Waajiri Jumla',
    jobApplications: 'Maombi ya Kazi',
    platformModules: 'Moduli za Jukwaa',
    loadingStats: 'Inapakia takwimu za dashibodi...',
