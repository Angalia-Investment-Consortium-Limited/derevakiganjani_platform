...
`).forEach(function(g){p=g.indexOf(":"),u=g.substring(0,p).trim().toLowerCase(),d=g.substring(p+1).trim(),!(!u||i[u]&&sa[u])&&(u==="set-cookie"?i[u]?i[u].push(d):i[u]=[d]:i[u]=i[u]?i[u]+", "+d:d)}),i};const gr=Symbol("internals");function St(r){return r&&String(r).trim().toLowerCase()}function Wt(r){return r===!1||r==null?r:v.isArray(r)?r.map(Wt):String(r)}function ia(r){const i=Object.create(null),u=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;let d;for(;d=u.exec(r);)i[d[1]]=d[2];return i}const oa=r=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(r.trim());function Kn(r,i,u,d,p){if(v.isFunction(d))return d.call(this,i,u);if(p&&(i=u),!!v.isString(i)){if(v.isString(d))return i.indexOf(d)!==-1;if(v.isRegExp(d))return d.test(i)}}function aa(r){return r.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(i,u,d)=>u.toUpperCase()+d)}function ca(r,i){const u=v.toCamelCase(" "+i);["get","set","has"].forEach(d=>{Object.defineProperty(r,d+u,{value:function(p,w,g){return this[d].call(this,i,p,w,g)},configurable:!0})})}class zt{constructor(i){i&&this.set(i)}set(i,u,d){const p=this;function w(T,k,A){const C=St(k);if(!C)throw new Error("header name must be a non-empty string");const L=v.findKey(p,C);(!L||p[L]===void 0||A===!0||A===void 0&&p[L]!==!1)&&(p[L||k]=Wt(T))}const g=(T,k)=>v.forEach(T,(A,C)=>w(A,C,k));if(v.isPlainObject(i)||i instanceof this.constructor)g(i,u);else if(v.isString(i)&&(i=i.trim())&&!oa(i))g(ra(i),u);else if(v.isObject(i)&&v.isIterable(i)){let T={},k,A;for(const C of i){if(!v.isArray(C))throw TypeError("Object iterator must return a key-value pair");T[A=C[0]]=(k=T[A])?v.isArray(k)?[...k,C[1]]:[k,C[1]]:C[1]}g(T,u)}else i!=null&&w(u,i,d);return this}get(i,u){if(i=St(i),i){const d=v.findKey(this,i);if(d){const p=this[d];if(!u)return p;if(u===!0)return ia(p);if(v.isFunction(u))return u.call(this,p,d);if(v.isRegExp(u))return u.exec(p);throw new TypeError("parser must be boolean|regexp|function")}}}has(i,u){if(i=St(i),i){const d=v.findKey(this,i);return!!(d&&this[d]!==void 0&&(!u||Kn(this,this[d],d,u)))}return!1}delete(i,u){const d=this;let p=!1;function w(g){if(g=St(g),g){const T=v.findKey(d,g);T&&(!u||Kn(d,d[T],T,u))&&(delete d[T],p=!0)}}return v.isArray(i)?i.forEach(w):w(i),p}clear(i){const u=Object.keys(this);let d=u.length,p=!1;for(;d--;){const w=u[d];(!i||Kn(this,this[w],w,i,!0))&&(delete this[w],p=!0)}return p}normalize(i){const u=this,d={};return v.forEach(this,(p,w)=>{const g=v.findKey(d,w);if(g){u[g]=Wt(p),delete u[w];return}const T=i?aa(w):String(w).trim();T!==w&&delete u[w],u[T]=Wt(p),d[T]=!0}),this}concat(...i){return this.constructor.concat(this,...i)}toJSON(i){const u=Object.create(null);return v.forEach(this,(d,p)=>{d!=null&&d!==!1&&(u[p]=i&&v.isArray(d)?d.join(", "):d)}),u}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([i,u])=>i+": "+u).join(`
